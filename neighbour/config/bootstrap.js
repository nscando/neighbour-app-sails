...
module.exports.bootstrap = async function () {
  ...
  var nico = await User.create({
    emailAddress: "nico@example.com",
    fullName: "Nicolas Scandizzo",
    password: await sails.helpers.passwords.hashPassword("123456"),
  }).fetch();
  var angy = await User.create({
    emailAddress: "angy@example.com",
    fullName: "Angy",
    password: await sails.helpers.passwords.hashPassword("abc123"),
  }).fetch();
  var rachael = await User.create({
    emailAddress: "rachael@example.com",
    fullName: "Rachael Shaw",
    password: await sails.helpers.passwords.hashPassword("abc123"),
  }).fetch();
  var mike = await User.create({
