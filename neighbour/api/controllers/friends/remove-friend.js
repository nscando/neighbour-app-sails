module.exports = {
  ...
  description:
    "Remove a user from the logged-in user's friends list, and vice-versa.",
  ...
  fn: async function ({ id }) {
    var friendToRemove = await User.findOne({ id }).populate("friends");
    ...
    await User.removeFromCollection(this.req.me.id, "friends").members([id]);
    ...
    await User.removeFromCollection(id, "friends").members([this.req.me.id]);
  },
};
